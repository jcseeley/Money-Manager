...
const NetWorthDash = () => {
  ...
  const handleFormSubmission = (event) => {
    ...
    const cryptoInput = parse(event.target.crypto.value) || 0;
    const retirementInput = parse(event.target.retirement.value) || 0;
    const iraInput = parse(event.target.ira.value) || 0;
    const investmentInput = parse(event.target.investments.value) || 0;
    ...
    return getValues(emergencyMonthsInput, employerPlanInput, employerMatchInput, ageInput, checkingInput, savingsInput, realEstateInput, cryptoInput, retirementInput, iraInput, investmentInput, carAssetInput, creditDebtInput, studentDebtInput, carLoanInput, mortgageInput, stateInput, annualIncomeInput, housingInput, healthcareInput, foodInput, studentPaymentInput, carPaymentInput, cashMonthlyInput, retirementMonthlyInput, iraMonthlyInput, brokerageMonthlyInput, travelInput, diningInput, shoppingInput, otherInput);
  }
  ...
  const getValues = (emergencyMonthsInput, employerPlanInput, employerMatchInput, ageInput, checkingInput, savingsInput, realEstateInput, cryptoInput, retirementInput, iraInput, investmentInput, carAssetInput, creditDebtInput, studentDebtInput, carLoanInput, mortgageInput, stateInput, annualIncomeInput, housingInput, healthcareInput, foodInput, studentPaymentInput, carPaymentInput, cashMonthlyInput, retirementMonthlyInput, iraMonthlyInput, brokerageMonthlyInput, travelInput, diningInput, shoppingInput, otherInput) => {
    ...
    const totalAssetVal = getAssetTotal(checkingInput, savingsInput, realEstateInput, cryptoInput, retirementInput, iraInput, investmentInput, carAssetInput);
    ...
    const totalSavingsVal = getMonthlySavingsTotal(cashMonthlyInput, retirementMonthlyInput, iraMonthlyInput, brokerageMonthlyInput);
    ...
    const savingsArr = getSavingsContributions(ageInput, checkingInput, idealCheckingVal, savingsInput, idealSavingsVal, monthlyPostTaxVal, monthlyNecessaryVal, idealSaveVal, employerPlanInput);
    ...
    return setValues(emergencyMonthsInput, employerPlanInput, employerMatchInput, ageInput, checkingInput, savingsInput, realEstateInput, cryptoInput, retirementInput, iraInput, investmentInput, carAssetInput, creditDebtInput, studentDebtInput, carLoanInput, mortgageInput, totalLiabilitiesVal, totalAssetVal, netWorthVal, stateInput, annualIncomeInput, annualPostTaxVal, monthlyIncomeVal, monthlyPostTaxVal, housingInput, healthcareInput, foodInput, studentPaymentInput, carPaymentInput, monthlyNecessaryVal, cashMonthlyInput, retirementMonthlyInput, iraMonthlyInput, brokerageMonthlyInput, totalSavingsVal, travelInput, diningInput, shoppingInput, otherInput, monthlyExtraVal, totalMonthlyVal, monthlyNetVal, idealCheckingVal, checkingDifVal, idealSavingsVal, savingsDifVal, idealHousingVal, idealNeedsVal, idealSaveVal, idealWantsVal, idealCashVal, idealRetirementVal, idealIraVal, idealBrokerageVal, employerMatchVal, employerMatchMax);
  }
        ...
        <form id="form" className="justify-self-center" onSubmit={handleFormSubmission}>
            ...
            <tbody>
              ...
              <tr className="hover">
                <td>
                  ...
                  <p className="text-xs italic underline mt-1">50-30-20</p>
                  <p className="text-xs italic">1 months expenses + 30%</p>
                </td>
                <td>
              ...
              <tr className="hover">
                <td className="w-60">
                  <p>Savings Account</p>
                  <p className="text-xs italic underline mt-1">50-30-20</p>
                  <p className="text-xs italic">#emergency months x expenses</p>
                </td>
                <td className="w-44">
              ...
              {/* TOTAL ASSETS ROW */}
              <tr className="hover">
                <td className="font-bold italic">Total Assets</td>
                <td></td>
                <td className="font-bold">{formatDollars(totalAssets)}</td>
              </tr>
            </tbody>
          </table>
          {/* LIABILITIES TABLE */}
          <table className="table table-compact mb-6">
            ...
            <tbody>
              ...
              <tr className="hover">
                <td className="font-bold italic">Total Liabilities</td>
                <td></td>
                <td className="font-bold">{formatDollars(totalLiabilities)}</td>
              </tr>
              {/* NET WORTH ROW */}
              <tr className="hover">
                <td className="w-fit font-bold">Net Worth</td>
                <td className="text-center italic font-bold">Assets - Liabilities</td>
                <td className="font-bold">{formatDollars(netWorth)}</td>
              </tr>
            </tbody>
          </table>
          {/* INCOME TABLE */}
          <table className="table table-compact mb-4">
            ...
            <tbody>
              ...
              <tr className="hover">
                <td className="font-bold italic">Monthly Net Income</td>
                <td></td>
                <td className="font-bold">{formatDollars(postTaxMonthlyIncome)}</td>
              </tr>
            </tbody>
          </table>
          {/* MONTHLY NEEDS TABLE */}
            ...
            <tbody>
              ...
              <tr className="hover">
                <td className="w-60">
                  ...
                  <p className="text-xs italic font-bold mt-1">* Ideal = 30% Monthly Net *</p>
                </td>
                <td>
                ...
                <td>{formatDollars(idealHousing)}</td>
              </tr>
          ...
          <table className="table table-compact">
            ...
            <tbody>
              ...
              <tr className="hover">
                ...
                <td>{formatDollars(idealCashMonthly)}</td>
              </tr>
              ...
              <tr className="hover">
                ...
                <td>{formatDollars(idealRetirementMonthly)}</td>
              </tr>
              {/* EMPLOYER RETIREMENT MATCH */}
              <tr className="hover">
                <td className="w-fit">
                  <p>Employer Retirement Match</p>
                  <p className="text-xs italic font-bold mt-1">* Ideal = possible max per month *</p>
                </td>
                <td className="text-center">{employerMatch}%</td>
                <td>{formatDollars(retirementEmployerMatch)}</td>
                <td>{formatDollars(maxEmployerMatch)}</td>
              </tr>
              {/* MONTHLY IRA INPUT */}
              <tr className="hover">
                <td className="w-fit">
                ...
                <td>{formatDollars(idealIraMonthly)}</td>
              </tr>
              ...
              <tr className="hover">
                ...
                <td>{formatDollars(idealBrokerageMonthly)}</td>
              </tr>
              {/* MONTHLY SAVINGS TOTAL */}
              <tr className="hover">
                <td className="font-bold italic">
                  <p>Savings Total</p>
                  <p className="text-xs italic font-bold mt-1">* Ideal = 20% Monthly Net *</p>
                </td>
                <td></td>
                <td className="font-bold">{formatDollars(totalSavingsMonthly)}</td>
                <td className="font-bold">{formatDollars(idealSavingsMonthly)}</td>
              </tr>
            </tbody>
          </table>
          {/* MONTHLY WANTS TABLE */}
          <table className="table table-compact">
            ...
            <tbody>
              ...
              <tr className="hover">
                ...
                <td></td>
                <td className="font-bold">{formatDollars(totalExtras)}</td>
                <td className="font-bold">{formatDollars(idealTotalExtras)}</td>
              </tr>
              {/* MONTHLY EXPENSES TOTAL */}
              <tr className="hover">
                <td className="font-bold italic">
                  <p>Total Monthly Expense</p>
                  <p className="text-xs italic font-bold mt-1">* Ideal = Monthly Net *</p>
                </td>
                <td></td>
                <td className="font-bold">{formatDollars(totalMonthlyExpenses)}</td>
                <td className="font-bold">{formatDollars(postTaxMonthlyIncome)}</td>
              </tr>
              {/* MONTHLY NET INCOME */}
              <tr className="hover">
                ...
                <td className="font-bold italic">Monthly Net - Expenses</td>
                <td className="font-bold">{formatDollars(netMonthlyIncome)}</td>
              </tr>
            </tbody>
          </table>
          {/* SUBMIT FORM BUTTON */}
